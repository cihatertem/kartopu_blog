...
def create_image(width, height, format="JPEG"):
    ...
    file.seek(0)
    return SimpleUploadedFileimport io
    from unittest.mock import patch
    ...
    class UserManagerTests(TestCase):
        ...
        def test_create_superuser_missing_email(self):
            ...
            # Act & Assert
            with self.assertRaisesMessage(ValueError, "Süper kullanıcıların bir email adresi olmalı"):
        ...
        def test_create_superuser_is_staff_false(self):
            ...
            # Act & Assert
            with self.assertRaisesMessage(ValueError, "Süper kullanıcı 'is_staff=True' olmalı."):
        ...
        def test_create_superuser_is_superuser_false(self):
            ...
            # Act & Assert
            with self.assertRaisesMessage(ValueError, "Süper kullanıcı 'is_superuser=True' olmalı."):
    ...
    class UserModelTests(TestCase):
        def test_str_with_full_name(self):
            # Arrange
            user = User.objects.create_user(email="test@example.com", first_name="John", last_name="Doe", password="pwd")
        ...
        def test_full_name_property(self):
            # Arrange
            user = User.objects.create_user(email="test3@example.com", first_name="Jane", last_name="Smith", password="pwd")
